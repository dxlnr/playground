...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CameraWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CameraWidget_t qt_meta_stringdata_CameraWidget = {
    {
        QT_MOC_LITERAL(0, 12)   // "CameraWidget"
    },
    "CameraWidget"
};
...
Q_CONSTINIT static const uint qt_meta_data_CameraWidget[] = {
...
Q_CONSTINIT const QMetaObject CameraWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CameraWidget.offsetsAndSizes,
    qt_meta_data_CameraWidget,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CameraWidget_t,
        // Q_OBJECT / Q_GADGET
